...
export const ROLE_PERMISSION_UPDATED = 'ROLE_PERMISSION_UPDATED';
export const USER_INFORMATION = (localStorage.userinformation !== undefined ) ? JSON.parse(localStorage.userinformation) : '';
